@{
    ...
    WelcomePrompt = @{
        Classic = @{
            ...
            CountdownMessage = 'Installationen kommer fortsätta automatiskt om:'

            # This is a custom message to display at the Welcome Screen window.
            CustomMessage = 'Twingate kommer att installeras/uppdateras. Avsluta ditt samtal INNAN du klickar på Fortsätt. Det kommer medföra ett tillfälligt avbrott i din VPN-anslutning. Du kan flytta på fönstret tillfälligt för att slutföra ditt samtal.
		
		När Twingate har startat upp igen så kan du behöva logga in på nytt.'
        }
        Fluent = @{
